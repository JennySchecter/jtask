        ...
        <div class="box-body no-padding">
            <table class="table table-condensed table-bordered text-center">
                <tbody>
                    ...
                    <tr>
                        <td>订单编号：</td>
                        <td><?= $form->field($model, 'order_num')->label(false)->textInput(['readonly'=>true,'value'=>$fbaModel->orderNum]) ?></td>
                        <td>客户名称：</td>
                        <td><?= $form->field($model, 'member_name')->label(false)->textInput(['maxlength' => true,'readonly'=>true,'value'=>$fbaModel->memberName]) ?></td>
                        <td>调查渠道：</td>
