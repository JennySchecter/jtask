    ...
    <div class="box box-info">
        ...
        <form class="form-horizontal">
            ...
            <div class="box-footer">
                ...
                <?=Html::a('导出',yii\helpers\Url::to(['/waybill/bill-export']),['class'=>'btn btn-default'])?>
            </div>
            <?php ActiveForm::end();?>
            <!-- /.box-footer -->
        </form>
                        ...
                        <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                            ...
                            <?php $i = 0; foreach ($waybills as $waybill):?>
                                <tr role="row" class="<?= $i%2==1? 'odd':'even' ;?>">
                                    ...
                                    <td><?php
                                        if(isset(Yii::$app->params['abnormalDomesticStatus'][$waybill['waybillStatus']['statusAbnormalDomestic']])){
                                            echo Yii::$app->params['abnormalDomesticStatus'][$waybill['waybillStatus']['statusAbnormalDomestic']];
                                        }
                                        ?></td>
